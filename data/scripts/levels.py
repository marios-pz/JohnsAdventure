...
class CaveRoom1(GameState):
    def __init__(self, player_instance, prop_objects):
        super(CaveRoom1, self).__init__(
            player_instance,
            prop_objects,
            "cave_room_1",
            light_state="inside_dark",
    ...
    def update(self, camera, dt) -> None:
        ...
        pg.draw.rect(
            self.screen,
            (0, 0, 0),
            [*(vec(-100, 1170) - vec(self.scroll)), 3230, 130],
        )

        pg.draw.rect(
            self.screen,
            (0, 0, 0),
            [*(vec(2370, -300) - vec(self.scroll)), 800, 1500],
        )
...
class CaveRoom2(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.spawn = {
            ...
            "cave_room_3": (SPAWN_CAVE_LEFT + 160, 500),
        }
        self.exit_rects = {
            "cave_room_1": (
                Rect(SPAWN_CAVE_TOPRIGHT, 150, 200, 100),
    ...
    def update(self, camera, dt) -> None:
        ...
        pg.draw.rect(
            self.screen,
            (0, 0, 0),
            [*(vec(35, 35) - vec(self.scroll)), 220, 925],
        )
...
class CaveRoom3(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_2": (SPAWN_CAVE_RIGHT - 150, 500),
            "cave_room_4": (SPAWN_CAVE_LEFT + 80, 800),
        }
        self.exit_rects = {
            "cave_room_2": (
    ...
    def update(self, camera, dt) -> None:
        ...
        pg.draw.rect(
            self.screen,
            (0, 0, 0),
            [*(vec(2120, 35) - vec(self.scroll)), 220, 925],
        )
...
class CaveRoom4(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_3": (SPAWN_CAVE_TOPRIGHT + 80, 250),
            "cave_room_5": (SPAWN_CAVE_LEFT + 80, 270),
        }
        self.exit_rects = {
            "cave_room_3": (
...
class CaveRoom5(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_4": (SPAWN_CAVE_RIGHT - 120, 800),
            "cave_room_6": (280, 500),
        }
        self.exit_rects = {
            "cave_room_4": (
                Rect(2000, 950, 200, 100),
                "",
                "mandatory",
            ),
            "cave_room_6": (
...
class CaveRoom6(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_5": (SPAWN_CAVE_RIGHT - 150, 500),
            "cave_room_7": (SPAWN_CAVE_LEFT + 80, 800),
        }
        self.exit_rects = {
            "cave_room_5": (
                Rect(SPAWN_CAVE_RIGHT, 250, 50, 700),
...
class CaveRoom8(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_7": (SPAWN_CAVE_RIGHT - 150, 500),
            "cave_room_9": ((SPAWN_CAVE_LEFT + 80, 800)),
        }
        self.exit_rects = {
            "cave_room_7": (
                Rect(SPAWN_CAVE_RIGHT, 250, 50, 700),
    ...
    def update(self, camera, dt) -> None:
        ...
        pg.draw.rect(
            self.screen,
            (0, 0, 0),
            [*(vec(-100, 1170) - vec(self.scroll)), 3230, 500],
        )
...
class CaveRoom9(GameState):
    def __init__(self, player_instance, prop_objects):
        ...
        self.ended_script = True
        self.spawn = {
            "cave_room_8": (SPAWN_CAVE_LEFT + 80, 270),
            "cave_entrance": (SPAWN_CAVE_RIGHT - 150, 500),
        }
        self.exit_rects = {
            "cave_room_8": (
                Rect(150, 150, 200, 100),
